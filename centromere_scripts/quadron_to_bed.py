...
base_input_dir = '/home/alextu/scratch/centromere_analysis/verkko123_quadron_q19_active_asat_HOR_arrays_filtered_csv'
base_output_dir = '/home/alextu/scratch/centromere_analysis/verkko123_quadron_active_asat_HOR_arrays_collapsed'
...
for chromosome in chromosomes:
    ...
    output_dir = os.path.join(base_output_dir, chromosome)

    # Create the output directory if it doesn't exist
    os.makedirs(output_dir, exist_ok=True)

    # Process the CSV files in the current chromosome directory
