...
#SBATCH --array=0-31   # Modify this based on the number of samples

# Directory containing input FASTA files
INPUT_DIR="/home/alextu/scratch/centromere_analysis/haplotype_centromere_fastas_active_asat_HOR_arrays/chr1"

# Output directory for non-B DNA annotations
OUTPUT_DIR="/home/alextu/scratch/centromere_analysis/verkko123_nBMST_active_asat_HOR_arrays_annotations/chr1/"
