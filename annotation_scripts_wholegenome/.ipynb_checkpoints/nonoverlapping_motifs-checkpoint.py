...
# This script collapses and merges overlapping intervals for non-b gfa produced annotations
...
def process_all_haplotypes(base_dir, features, output_base_dir):
    ...
    haplotype_dirs = glob.glob(os.path.join(base_dir, '*_hap*'))
...
base_dir = '/home/alextu/scratch/nonb_motif_annotations_hgsvc/20240201_verkko_batch3_nonb_annotations_aligned_chm13'

# Define the base directory to output processed files
output_base_dir = '/home/alextu/scratch/nonb_motif_annotations_hgsvc/20240201_verkko_batch3_nonb_annotations_collapsed_chm13'

# Define the list of features to process
features = ['APR', 'DR', 'IR', 'MR', 'Z']

# Process all haplotype directories
process_all_haplotypes(base_dir, features, output_base_dir)
