...
def process_all_haplotypes(base_dir, features, output_base_dir):
    ...
    haplotype_dirs = glob.glob(os.path.join(base_dir, '*chr22*'))
...
base_dir = '/home/alextu/scratch/rdna_analysis/rdna_annotations_verkko_123_aligned_chm13_v2_nBMST/chr22'

# Define the base directory to output processed files
output_base_dir = '/home/alextu/scratch/rdna_analysis/rdna_annotations_verkko_123_aligned_collapsed_chm13_v2_nBMST/chr22'
