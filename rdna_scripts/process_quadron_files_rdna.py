...
base_directory_path = '/home/alextu/scratch/rdna_analysis/rDNA_extracted_chm13_ref_genome/quadron_results_chm13'

# Output base directory
output_base_directory = '/home/alextu/scratch/rdna_analysis/rDNA_extracted_chm13_ref_genome/quadron_q19_filtered_csv'
...
for file_name in os.listdir(base_directory_path):
    ...
    if os.path.isfile(file_path):
        ...
        if data_rows:
            ...
            output_file = os.path.join(output_base_directory, output_file_name)
