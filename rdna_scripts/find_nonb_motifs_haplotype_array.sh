...
#SBATCH --array=0-64   # Modify this based on the number of samples

# Directory containing input FASTA files
INPUT_DIR="/home/alextu/scratch/rdna_analysis/rdna_filtered_chr_fasta_2_no_N/chr22"

# Output directory for non-B DNA annotations
OUTPUT_DIR="/home/alextu/scratch/rdna_analysis/rdna_annotations_verkko_123_aligned_chm13_v2/chr22/"
